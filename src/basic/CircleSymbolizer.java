...
public class CircleSymbolizer {
	...
	public PImage produceSymbol(){
		...
		while(Matrix2D.count(matrix)<sizeX*sizeY/5 || Matrix2D.count(matrix)>sizeX*sizeY*4/5){
			...
			// removing black pixels outside inner circle,
			// adding black pixels within circle
	...
	public static void main(String[] args) {
		CircleSymbolizer sz = new CircleSymbolizer();
		for(int i=0;i<200;i++){
